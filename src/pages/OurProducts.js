...
export default function OurProducts() {
  ...
  const scrollToElement = () => {
    ...
    const navbarHeight = 90; // agar navbar fixed hai
    const elementTop =
...
<section className="mt-3">
  <img
    src="https://www.shutterstock.com/image-vector/bridge-construction-banner-professional-modern-260nw-1037950057.jpg"
  ...
  <div className="container">
    ...
    <div className="row">
      ...
      {/* PPC */}
      <div className="col-md-4 mb-4" data-aos="fade-up" id="ppc">
      ...
      {/* OPC 53 */}
      <div className="col-md-4 mb-4" data-aos="fade-up" data-aos-delay="100" id="opc53">
        <div className="product-card">
          <div className="product-img">
            <img
      ...
      {/* OPC 43 */}
      <div className="col-md-4 mb-4" data-aos="fade-up" data-aos-delay="200" id="opc43">
        <div className="product-card">
          <div className="product-img">
            <img
      ...
      {/* PSC */}
      <div className="col-md-6 mb-4" data-aos="fade-up" id="psc">
        <div className="product-card">
          <div className="product-img">
            <img
